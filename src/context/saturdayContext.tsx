...
export const SaturdayContext = createContext<ContextData>({} as ContextData);

export function SaturdayProvider({ children }: workoutProviderProps) {
  ...
  return (
    <SaturdayContext.Provider value={{ trainingWeeks, createTrainingWeeks }}>
      {children}
    </SaturdayContext.Provider>
  );
}
