...
export const TuesdayContext = createContext<ContextData>({} as ContextData);

export function TuesdayProvider({ children }: workoutProviderProps) {
  ...
  return (
    <TuesdayContext.Provider value={{ trainingWeeks, createTrainingWeeks }}>
      {children}
    </TuesdayContext.Provider>
  );
}
