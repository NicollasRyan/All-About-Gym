...
export const MondayContext = createContext<ContextData>({} as ContextData);

export function MondayProvider({ children }: workoutProviderProps) {
  ...
  return (
    <MondayContext.Provider value={{ trainingWeeks, createTrainingWeeks }}>
      {children}
